...
const props = defineProps(['form', 'show_edit_category_modal']);
const emits = defineEmits(['closeCategoryModel']);

const editCategoryForm = async (id) => {
    await props.form.put(`/category/${id}`, {
        onSuccess: () => {
            closeCategoryModel();
        }
    })
...
<template>
    <div v-if="show_edit_category_modal" id="create-inventory-modal" class="fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-gray-500">
        <div class="relative p-4 w-full max-w-2xl max-h-full mx-auto">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form class="p-5" @submit.prevent="editCategoryForm(props.form.id)">
